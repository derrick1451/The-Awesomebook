...
**THE AWESOME-BOOK** in this milestone we implemented the awesome books page by using es6 modules to update and show the books and also use local storage to keep track of the books
...
Feel free to check the [issues page](https://github.com/derrick1451/The-Awesomebook/issues).
